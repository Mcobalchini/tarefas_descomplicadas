...
export default class ToDoList extends React.Component {
    handleDeleteToDoList = (toDoList) => {
        Alert.alert("Atenção",
            `Deseja realmente excluir a lista ${toDoList.name}?`,
            [
                {
                    text: "Cancelar",
                    style: "cancel",
                ...
                },
                {
                    text: "Excluir",
                    onPress: () => {
                        const deleteToDoListService = DeleteToDoListService();
    ...
    render() {
        ...
        return (
            <View>
                <TouchableOpacity onLongPress={() => this.handleDeleteToDoList(toDoList)}
